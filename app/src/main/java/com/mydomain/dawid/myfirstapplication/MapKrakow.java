...
public class MapKrakow extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_krakow);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng krakow = new LatLng(50.06561980, 19.946850);
